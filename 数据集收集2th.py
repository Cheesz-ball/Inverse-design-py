...
# 选择文件根目录
# -----------------------------------------------------------------------------
path = r"C:\Users\CHEESZ\Desktop\Test1"
# 创建文件夹
...
# -----------------------------------------------------------------------------
# 调用函数加载 now
progress_file_path = os.path.join(folder_paths[3], "progress2.txt")
...
'''
    ...
    for i in range(now, now+n_single_sim):
        ...
        modelers.add_to_history('ComponentDelete','Component.Delete "b1" ')
        modelers.add_to_history('ComponentDelete','Component.Delete "b2" ')
        modelers.add_to_history('ComponentDelete','Component.Delete "c1" ')
        modelers.add_to_history('ComponentDelete','Component.Delete "c2" ')
        modelers.add_to_history('ComponentDelete','Component.Delete "c3" ')
        now=i
